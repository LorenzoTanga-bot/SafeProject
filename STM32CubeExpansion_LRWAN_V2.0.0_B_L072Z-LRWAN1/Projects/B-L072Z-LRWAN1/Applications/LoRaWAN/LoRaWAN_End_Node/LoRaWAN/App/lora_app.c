...
static void OnRxData(LmHandlerAppData_t *appData, LmHandlerRxParams_t *params)
{
  ...
  if ((appData != NULL) && (params != NULL))
  {
    ...
    switch (appData->Port)
    {
      ...
      {
    	  /*
    	  uint16_t payload = ((uint16_t) appData->Buffer[1] << 8) | appData->Buffer[0];
    	  APP_LOG(TS_OFF, VLEVEL_M, "Buffer size: %d\r\n", appData->BufferSize);
    	  APP_LOG(TS_OFF, VLEVEL_M, "Test value: %d\r\n", payload);
    	  */
      }
